...
%% This function compares time series data for trials across two experimental conditions.
%
%   [clusters, pSig, tSumsSig] = ieeg_clusterTest(x1, x2, alphaThresh, alphaFA, nperm)
%
...
%
    ...
    if isempty(rgs)
        ...
        % PK edits (01/24) to ensure that output can still be saved
        pSig = .99; 
        tSumsSig = [];
